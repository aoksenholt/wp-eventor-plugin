...
class PersonResultsForYearQuery extends Query
{
	...
	{				
		...
		$html .= "<table><th></th><th></th><th></th><th align='right'>Nr</th><th align='right'>Tid</th><th align='right'>Etter</th>";
		...
		foreach ($arr as $resultList) 
		{
			...
			{			
				$html .= "<tr><td>$eventDate</td><td>$eventLink</td><td>$classResultLink</td><td align='right'>$resultPosition</td><td align='right'>$time</td><td align='right'>$timediff</td></tr>";
			}
		}
